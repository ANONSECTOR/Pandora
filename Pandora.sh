...
printf "\ e [1; 92m .- \" \ "\" \ "-. \ e [0m \ n"
printf "\ e [1; 92m / \ \ e [0m \ n"
printf "\ e [1; 77m _ _ ____ \ e [0m \ e [1; 92m / _ _ \ \ e [0m \ n"
printf "\ e [1; 77m | | | | ___ ___ _ __ | _ \ ___ ___ ___ _ __ \ e [0m \ e [1; 92m // \ / \\ \ e [0m \ n"
printf "\ e [1; 77m | | | / __ | / _ \ '__ | | _) / _ \ / __ / _ \ |' _ \ \ e [0m \ e [1; 92m | \ __ \ / __ / | \ e [0m \ n "
printf "\ e [1; 77m | | _ | \ __ \ __ / | | _ <__ / (_ | (_) | | | | \ e [0m \ e [1; 92m \ || / \ e [ 0m \ n "
printf "\ e [1; 77m \ ___ / | ___ / \ ___ | _ | | _ | \ _ \ ___ | \ ___ \ ___ / | _ | | _ | \ e [0m \ e [1; 92m \ / \ e [0m \ n "
printf "\ e [1; 92mv1.0, Autor: @ANONSECTOR \ e [0m \ e [1; 92m \ __ / \ e [0m \ n"
printf "\ e [1; 92m '.__.' \ e [0m \ n "
...
if [[-e $ username.txt]]; então
printf "\ e [1; 92m [\ e [0m \ e [1; 77m * \ e [0m \ e [1; 92m] Salvo: \ e [0m \ e [1; 77m% s.txt \ n" $ nome de usuário
fi
...
ler -p $ '\ e [1; 92m [\ e [0m \ e [1; 77m? \ e [0m \ e [1; 92m] Nome de usuário de entrada: \ e [0m' nome de usuário

if [[-e $ username.txt]]; então
printf "\ e [1; 92m [\ e [0m \ e [1; 77m * \ e [0m \ e [1; 92m] Removendo arquivo anterior: \ e [0m \ e [1; 77m% s.txt" $ nome de usuário
rm -rf $ username.txt
fi
printf "\ n"
printf "\ e [1; 92m [\ e [0m \ e [1; 77m * \ e [0m \ e [1; 92m] Verificando nome de usuário \ e [0m \ e [1; 77m% s \ e [0m \ e [1; 92m em: \ e [0m \ n "$ nome de usuário

## INSTAGRAM

check_insta = $ (curl -s -H "Accept-Language: en" "https://www.instagram.com/$username" -L | grep -o 'O link que você seguiu pode estar quebrado'; echo $?)
printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] Instagram: \ e [0m"

if [[$ check_insta == * '1' *]]; então
printf "\ e [1; 92m encontrado! \ e [0m https://www.instagram.com/%s\n" $ nome de usuário
printf "https://www.instagram.com/%s\n" $ username> $ username.txt
elif [[$ check_insta == * '0' *]]; então
printf "\ e [1; 93mNão encontrado! \ e [0m \ n"
fi

## Facebook

printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] Facebook: \ e [0m"
check_face = $ (curl -s "https://www.facebook.com/$username" -L -H "Accept-Language: en" | grep -o 'não encontrado'; echo $?)


if [[$ check_face == * '1' *]]; então
printf "\ e [1; 92m encontrado! \ e [0m https://www.facebook.com/%s\n" $ nome de usuário
printf "https://www.facebook.com/%s\n" $ username >> $ username.txt
elif [[$ check_face == * '0' *]]; então
printf "\ e [1; 93mNão encontrado! \ e [0m \ n"
fi
...
check_twitter = $ (curl -s "https://www.twitter.com/$username" -L -H "Accept-Language: en" | grep -o 'a página não existe'; echo $?)


if [[$ check_twitter == * '1' *]]; então
printf "\ e [1; 92m encontrado! \ e [0m https://www.twitter.com/%s\n" $ nome de usuário
printf "https://www.twitter.com/%s\n" $ username >> $ username.txt
elif [[$ check_twitter == * '0' *]]; então
printf "\ e [1; 93mNão encontrado! \ e [0m \ n"
fi
...
check_youtube = $ (curl -s "https://www.youtube.com/$username" -L -H "Accept-Language: en" | grep -o 'Não encontrado'; echo $?)


if [[$ check_youtube == * '1' *]]; então
printf "\ e [1; 92m encontrado! \ e [0m https://www.youtube.com/%s\n" $ nome de usuário
printf "https://www.youtube.com/%s\n" $ username >> $ username.txt
elif [[$ check_youtube == * '0' *]]; então
printf "\ e [1; 93mNão encontrado! \ e [0m \ n"
fi
...
if [[$ check == * '1' *]]; então
printf "\ e [1; 92m encontrado! \ e [0m https: //%s.blogspot.com \ n" $ nome de usuário
printf "https: //%s.blogspot.com \ n" $ username >> $ username.txt
elif [[$ check == * '0' *]]; então
printf "\ e [1; 93mNão encontrado! \ e [0m \ n"
fi
...
check1 = $ (curl -s -i "https: //$username.wordpress.com" -H "Accept-Language: en" -L --user-agent '"Mozilla / 5.0 (X11; U; Linux i686; en-US; rv: 0.9.3) Gecko / 20010801 "'| grep -o' Deseja se registrar '; echo $?)

if [[$ check1 == * '0' *]]; então
printf "\ e [1; 93mNão encontrado! \ e [0m \ n"
elif [[$ check1 == * '1' *]]; então

printf "\ e [1; 92m encontrado! \ e [0m https: //%s.wordpress.com \ n" $ nome de usuário
printf "https: //%s.wordpress.com \ n" $ username >> $ username.txt
fi
...
check1 = $ (curl -s -i "https://www.github.com/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla / 5.0 (X11; U; Linux i686; en-US; rv: 0.9.3) Gecko / 20010801 "'| grep -o' 404 Não encontrado '; echo $?)
...
printf "\ e [1; 92m encontrado! \ e [0m https: //%s.tumblr.com \ n" $ nome de usuário
printf "https: //%s.tumblr.com \ n" $ username >> $ username.txt
fi

## FLICKR

printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] Flickr: \ e [0m"
check1 = $ (curl -s -i "https://www.flickr.com/people/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla / 5.0 (X11; U ; Linux i686; en-US; rv: 0.9.3) Gecko / 20010801 "'| grep -o' Não encontrado '; echo $?)
...
check1 = $ (curl -s -i "https://steamcommunity.com/id/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla / 5.0 (X11; U; Linux i686; en-US; rv: 0.9.3) Gecko / 20010801 "'| grep -o' O perfil especificado não foi encontrado '; echo $?)
...
check1 = $ (curl -s -i "https://vimeo.com/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla / 5.0 (X11; U; Linux i686; en-US; rv: 0.9.3) Gecko / 20010801 "'| grep -o' 404 não encontrado '; echo $?)
...
check1 = $ (curl -s -i "https://soundcloud.com/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla / 5.0 (X11; U; Linux i686; en-US; rv: 0.9.3) Gecko / 20010801 "'| grep -o' 404 não encontrado '; echo $?)
...
check1 = $ (curl -s -i "https://disqus.com/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla / 5.0 (X11; U; Linux i686; en-US; rv: 0.9.3) Gecko / 20010801 "'| grep -o' 404 NÃO ENCONTRADO '; echo $?)
...
printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] Médio: \ e [0m"
...
printf "\ e [1; 92m encontrado! \ e [0m https: //%s.deviantart.com \ n" $ nome de usuário
printf "https: //%s.deviantart.com \ n" $ username >> $ username.txt
fi
...
printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] Movimento Diário: \ e [0m"
...
check1 = $ (curl -s -i "https://www.instructables.com/member/$username" -H "Accept-Language: en" -L | grep -o '404 NÃO ENCONTRADO'; echo $?)
...
printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] Base de teclado: \ e [0m"
...
printf "\ e [1; 92m encontrado! \ e [0m https: //%s.livejournal.com \ n" $ nome de usuário
printf "https: //%s.livejournal.com \ n" $ username >> $ username.txt
fi
...
printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] Codecademia: \ e [0m"
...
printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] Quadrangular: \ e [0m"
...
printf "\ e [1; 92m encontrado! \ e [0m https: //%s.newgrounds.com \ n" $ nome de usuário
printf "https: //%s.newgrounds.com \ n" $ username >> $ username.txt
fi
...
printf "\ e [1; 92m encontrado! \ e [0m https: //%s.hubpages.com/ \ n" $ nome de usuário
printf "https: //%s.hubpages.com/ \ n" $ username >> $ username.txt
fi

## Contently

printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] Contenciosamente: \ e [0m"
...
printf "\ e [1; 92m encontrado! \ e [0m https: //%s.contently.com \ n" $ nome de usuário
printf "https: //%s.contently.com \ n" $ username >> $ username.txt
fi

## Houzz

printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] Houzz: \ e [0m"
check1 = $ (curl -s -i "https://houzz.com/user/$username" -H "Accept-Language: en" -L | grep -o 'ocorreu um erro'; echo $?)
...
check1 = $ (curl -s -i "https://news.ycombinator.com/user?id=$username" -H "Accept-Language: en" -L | grep -o 'Não existe tal usuário'; echo $ ?)
...
printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] Designspiração: \ e [0m"
...
printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] ColorLovers: \ e [0m"
check1 = $ (curl -s -i "https://www.colourlovers.com/love/$username" -H "Accept-Language: en" -L | grep -o 'HTTP / 2 404 \ | 404 Não encontrado '; echo $?)
...
check1 = $ (curl -s -i "https://www.ifttt.com/p/$username" -H "Accept-Language: en" -L | grep -o 'HTTP / 2 404 \ | 404 Não encontrado '; echo $?)
...
check1 = $ (curl -s -i "https://www.ebay.com/usr/$username" -H "Accept-Language: en" -L | grep -o 'HTTP / 2 404 \ | 404 Não encontrado \ | Perfil do eBay - erro '; echo $?)
...
printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] Folga: \ e [0m"
check1 = $ (curl -s -i "https: //$username.slack.com" -H "Accept-Language: en" -L | grep -o 'HTTP / 2 404 \ | 404 Não encontrado'; echo $ ?)

if [[$ check1 == * '0' *]]; então
printf "\ e [1; 93mNão encontrado! \ e [0m \ n"
elif [[$ check1 == * '1' *]]; então

printf "\ e [1; 92m encontrado! \ e [0m https: //%s.slack.com \ n" $ nome de usuário
printf "https: //%s.slack.com \ n" $ username >> $ username.txt
fi

## OkCupid

printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] OkCupid: \ e [0m"
check1 = $ (curl -s -i "https://www.okcupid.com/profile/$username" -H "Accept-Language: en" -L | grep -o 'HTTP / 2 404 \ | 404 Não encontrado '; echo $?)
...
printf "\ e [1; 77m [\ e [0m \ e [1; 92m + \ e [0m \ e [1; 77m] Viagem: \ e [0m"
check1 = $ (curl -s -i "https://www.trip.skyscanner.com/user/$username" -H "Accept-Language: en" -L | grep -o 'HTTP / 2 404 \ | 404 Não encontrado \ | HTTP / 2 410 '; echo $?)
...
check1 = $ (curl -s -i "https://ello.co/$username" -H "Accept-Language: en" -L | grep -o 'HTTP / 2 404 \ | 404 Não encontrado'; echo $ ?)
...
printf "\ e [1; 92m encontrado! \ e [0m https: //%s.basecamphq.com/login \ n" $ nome de usuário
printf "https: //%s.basecamphq.com/login \ n" $ username >> $ username.txt
